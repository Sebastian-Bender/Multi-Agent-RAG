...
class RelevanceChecker:
    def __init__(self):
        ...
        #self.llm = ChatAnthropic(model="claude-3-5-haiku-latest", temperature=0.0)
        self.llm = ChatGoogleGenerativeAI(model='gemini-2.5-flash', temperature=0.0)
        #self.llm = init_chat_model(model='gemini-2.5-flash', model_provider='google_genai', temperature=0.0)
